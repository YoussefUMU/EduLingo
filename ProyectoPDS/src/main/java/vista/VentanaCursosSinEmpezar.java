...
public class VentanaCursosSinEmpezar extends JFrame {
		...
		btnEmpezar.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				if (cursoSeleccionado != null) {
					...
					CursoEnMarcha cursoEnMarcha = ControladorPDS.getUnicaInstancia().iniciarCursoE(cursoSeleccionado,
							estrategiaSeleccionada, obtenerTipoEstrategiaSeleccionada());

					if (cursoEnMarcha == null) {
						JOptionPane.showMessageDialog(null,
								"No puede empezar un curso dos veces con la misma estrategia.", "Error",
	...
	private void mostrarDialogoImportacion(int numCursos) {
		...
		JLabel messageLabel = new JLabel("<html><div style='text-align: center;'>" + "¡Importación exitosa!<br><br>"
	...
	private void setupWindowMovement() {
		MouseAdapter ma = new MouseAdapter() {
			...
			public void mouseDragged(MouseEvent e) {
				...
				setLocation(currentLocation.x + e.getX() - dragPoint.x, currentLocation.y + e.getY() - dragPoint.y);
			}
		};
	...
	class ModernCursoCellRenderer extends DefaultListCellRenderer {
		...
		public Component getListCellRendererComponent(JList<?> list, Object value, int index, boolean isSelected,
			...
			JLabel lblDescription = new JLabel(
					"<html><div style='width:350px'>" + curso.getDescripcion() + "</div></html>");
