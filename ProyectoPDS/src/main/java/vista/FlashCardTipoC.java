...
public class FlashCardTipoC extends JFrame {
    ...
    public FlashCardTipoC(CursoEnMarcha curso, int indBloque, int indPregunta) {
        // En un caso real, obtendríamos la información desde el curso
        // Para este ejemplo, crearemos datos de prueba
        crearDatosPrueba();
        ...
        btnCerrar.addActionListener(e -> {
            int respuesta = JOptionPane.showConfirmDialog(this, 
                "¿Seguro que deseas salir? Perderás el progreso de esta pregunta.", 
                "Confirmar salida", 
        ...
        zonaOpcionesPanel.setBorder(new CompoundBorder(
    ...
    private void crearEtiquetasArrastrables() {
        ...
        for (String opcion : opciones) {
            ...
            label.setBorder(new CompoundBorder(
                new LineBorder(colorAzul, 1, true),
            ...
            label.addMouseListener(new MouseAdapter() {
                ...
                public void mouseReleased(MouseEvent e) {
                    if (labelArrastrado == null) return;
                    ...
                    for (DropTargetPanel dropPanel : zonasRespuesta) {
                        if (dropPanel.getOcupada()) continue;
            ...
            label.addMouseMotionListener(new MouseMotionAdapter() {
                ...
                public void mouseDragged(MouseEvent e) {
                    if (labelArrastrado == null || draggedAt == null) return;
    ...
    private void verificarRespuestas() {
        ...
        if (!todasOcupadas) {
            JOptionPane.showMessageDialog(this, 
                "Por favor, completa todos los huecos antes de verificar.", 
        ...
        if (todasCorrectas) {
            ...
            Timer timer = new Timer(1200, e -> {
                JOptionPane.showMessageDialog(this, 
                    "¡Bien hecho! Has completado correctamente la frase.",
                    "Correcto", 
                    JOptionPane.INFORMATION_MESSAGE);
                dispose();
                new VentanaPrincipal().setVisible(true);
            ...
            if (ControladorPDS.getUnicaInstancia().tieneVidasInfinitas() || vidas > 0) {
                Timer timer = new Timer(1200, e -> {
                    ...
                    JOptionPane.showMessageDialog(this, 
                        "Hay " + incorrectas.size() + " respuestas incorrectas. ¡Inténtalo de nuevo!",
                        "Incorrecto", 
    ...
    private void mostrarAnimacionExito() {
        for (DropTargetPanel dropPanel : zonasRespuesta) {
            ...
            if (dropPanel.getRespuesta() != null) {
                ...
                dropPanel.getRespuesta().setBorder(new CompoundBorder(
                    new LineBorder(colorVerde.darker(), 1, true),
                    BorderFactory.createEmptyBorder(8, 12, 8, 12)
                ));
            }
        }
    ...
    private void mostrarAnimacionError(List<DropTargetPanel> incorrectas) {
        ...
        for (DropTargetPanel dropPanel : incorrectas) {
            ...
            if (dropPanel.getRespuesta() != null) {
                dropPanel.getRespuesta().setForeground(Color.WHITE);
                dropPanel.getRespuesta().setBorder(new CompoundBorder(
                    new LineBorder(colorRojo.darker(), 1, true),
                    BorderFactory.createEmptyBorder(8, 12, 8, 12)
                ));
            }
        }
    ...
    private void habilitarArrastreVentana() {
        ...
        getContentPane().addMouseMotionListener(new MouseAdapter() {
            ...
            public void mouseDragged(MouseEvent e) {
                if (labelArrastrado == null) {
                    setLocation(getLocation().x + e.getX() - posX.get(), 
                                getLocation().y + e.getY() - posY.get());
                }
            }
        });
    }
